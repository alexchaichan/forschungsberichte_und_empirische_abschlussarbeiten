...
Hier folgt ein Beispiel für eine Tabelle und eine Abbildung
...
starwars %>%
  ...
  kableExtra::footnote(general_title ="Datenbasis:" ,general = " ggplott - starwars")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="\\label{fig:plt1}Boxplot - Größe in cm",  fig.align="center"}
starwars %>% 
  select(height,mass) %>% 
  rename(Größe=height,
         Gewicht=mass) %>% 
